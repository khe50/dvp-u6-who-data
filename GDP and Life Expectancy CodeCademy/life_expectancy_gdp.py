...
#2003-2006
#Mexico
#First 5 are similar in their fluctuations, although different in magnitude.
#I don't think there is a huge correlation between life expectancy and GDP.
#How developed a country is determines its life expectancy and GDP.
...
#  #Zimbabwe
#  #US
#  #the USA's economy is stable, so its life expectancy didn't fluctuate as much as zimbabwe, which has a more unstable economy but has also seen a lot of growth in the last two decades.
...
#US is highest, Zimbabwe is lowest
